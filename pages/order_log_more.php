...
<body class="whitebody">
   ...
   <div class="col-lg-12">
           			...
           			<?php
							...
							function do_fetch($s)
							{
								...
								while($row = oci_fetch_array($s,OCI_RETURN_NULLS + OCI_ASSOC))
								{
									...
									if(is_null($flag)){
										echo "<td name="."flag"." value="."0"."><button onclick=enter(".$count.");>입고처리</button><button onclick=order_return($count);>반품요청</button></td>";
									}
									else {
										echo "<td name="."flag"." value="."1".">입고&nbsp;&nbsp;&nbsp;&nbsp;<button onclick=order_return($count);>반품요청</button></td>";
									}
    ...
    function order_return(row){
      var tr = document.getElementById("tr_"+row);
      var el = document.getElementByName("flag");
