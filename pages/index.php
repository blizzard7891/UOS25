                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                            	<li>
                            		<a href="#" onclick="changeUrl('order_product.php')">주문하기</a>
                            	</li>
                            	<li>
                            		<a href="#" onclick="changeUrl('order_log.php')">주문내역</a>
                            	</li>
                            	<li>
                            		<a href="#" onclick="changeUrl('order_return_log.php')">반품내역</a>
                            	</li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> 품목관리<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                            	<li>
                            		<a href="#" onclick="changeUrl('product_list.php')">판매상품</a>
                            	</li>
                            	<li>
                            		<a href="#" onclick="changeUrl('product_event.php')">행사상품</a>
                            	</li>
                            	<li>
                            		<a href="#" onclick="changeUrl('product_class.php')">품목분류</a>
                            	</li>
                            </ul>
                        </li>
                        <li>
