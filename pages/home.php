...
<div class="container-fluid headerBox" style="padding-right: 0px; padding-left: 0px; overflow: hidden;">
	...
	<div class="middle">
		...
		<h1 class="text-center headertext">UOS25 Management System</h1>
			...
			<div class="col-md-4">
				<div class="eventPart">
					...
					<div class="event-content">
                        ...
                        function do_fetch3($s)
                        {
                          while($row = oci_fetch_array($s,OCI_RETURN_NULLS + OCI_ASSOC))
                          {
                           	echo "<li class='ml-5' style='text-align:left'>[ ".$row['SEQ']." ]  ".$row['DESCRIPTION']."</li><hr>";
                         
                          }
                        }

                        $query = "SELECT seq,description FROM BOARD";
						...
						<a href="./board.php" class="btn btn-danger contact mt-3">바로가기</a>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="eventPart">
					...
					<div class="event-content">
                        ...
                        function do_fetch($s)
                        {
                          while($row = oci_fetch_array($s,OCI_RETURN_NULLS + OCI_ASSOC))
                          {
                           	echo "<li >[ 품목 ]  ".$row['PROD_NAME']."　[ 수량 ]  ".$row['QTY']."개</li><hr>";
						...
						<a href="stock_expdate_manage.php" class="btn btn-danger contact mt-3">바로가기</a>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="eventPart">
					...
					<ul>
                        ...
                        function do_fetch1($s)
                        {
                          while($row = oci_fetch_array($s,OCI_RETURN_NULLS + OCI_ASSOC))
                          {
                           	echo "<li >[ 관리 번호 ]  ".$row['MANAGEMENT_NUM']."<br>　[ 반납예정일 ]  ".$row['TMP']."</li><hr>";
						...
						<a href="service_battery.php" class="btn btn-danger contact mt-3">바로가기</a>
